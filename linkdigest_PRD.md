...
- **최종 업데이트**: 2026-02-14
- **작성자**: LinkDigest 개발팀
- **참고 문서**: [설계서](./linkdigest서비스.md), [Backend 문서](./backend/backend.md), [Frontend 문서](./frontend/frontend.md)
